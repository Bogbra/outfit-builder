...
export interface ProductCardProps {
  ...
  // lazy-loading for the likely LCP element.
  priority?: boolean;
}
      ...
      <CardHeader className="gap-2 p-4">
        <div className="flex items-start justify-between gap-2">
          {/* h2: the page's only <h1> is "Shop the catalog" above the grid,
              ...
              elsewhere on this page to nest under. */}
        ...
        <p className="text-base font-medium text-foreground">{formatPrice(product.priceMinor, product.currency)}</p>
      </CardHeader>
