...
// expiry. See docs/07-security.md "Session revocation". Best-effort: a
// failure here (e.g. apps/api unreachable) shouldn't strand the user unable
// to clear their own browser cookie.
