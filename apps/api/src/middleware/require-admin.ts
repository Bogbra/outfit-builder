...
// middleware check (apps/web/middleware.ts) is a UX convenience, not the
// security boundary. See docs/07-security.md "Auth".
export async function requireAdmin(req: Request, res: Response, next: NextFunction): Promise<void> {
  ...
  try {
    ...
    // was issued. This lookup is what makes revocation real (docs/07-security.md
    // "Session revocation"), at the cost of one indexed read per admin request.
