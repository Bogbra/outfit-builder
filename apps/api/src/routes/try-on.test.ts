...
// docs/07-security.md "Virtual try-on") before the dedicated rate-limit
// test below. Set before app.js (which transitively loads env.js) is
// imported — same trick admin.test.ts uses for ADMIN_PASSWORD_HASH.
