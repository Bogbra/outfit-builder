...
// architecture) with no connection to the product. `fit=crop` keeps every
// image the same 4:5 portrait aspect ratio the catalog grid expects.
...
const products: SeedProduct[] = [
  ...
  },
  {
    ...
    availability: "in_stock",
    // Both original photos for this product showed an identifiable face;
    // replaced with a single unbranded product shot instead of finding a
    // second one, since a minimum of one image is all the schema requires.
    images: unsplashImages("1620799140188-3b2a02fd9a77"),
  },
  {
    name: "Silk Blouse",
    slug: "silk-blouse",
  ...
  },
  {
    ...
    material: "Denim",
    availability: "in_stock",
    // Both original photos for this product showed visible brand tags/
    // logos (a shoe brand and a socks brand in the second one); replaced
    // with a single unbranded product shot instead of finding a second
    // one, since a minimum of one image is all the schema requires.
    images: unsplashImages("1714143136372-ddaf8b606da7"),
  },
  {
  ...
  },
  {
    ...
    material: "Linen",
    availability: "in_stock",
    // Both original photos showed an identifiable face (person doing a
    // yoga stretch); replaced with a single close-cropped, faceless shot
    // instead of finding a second one, since a minimum of one image is
    // all the schema requires.
    images: unsplashImages("1775970241220-1e7116e6d941"),
  },
  ...
  },
  {
    ...
    // Both original photos for this product showed a readable brand
    // wordmark on the shoe; replaced with a single unbranded product shot
    // instead of finding a second one, since a minimum of one image is
    // all the schema requires.
    images: unsplashImages("1634581448750-22a591d78099"),
  },
  {
    name: "Suede Loafers",
    slug: "suede-loafers",
    ...
    material: "Suede",
    availability: "in_stock",
    // Both original photos showed a readable brand name embossed on the
    // insole or branded hardware on the shoe; replaced with a single
    // unbranded product shot instead of finding a second one, since a
    // minimum of one image is all the schema requires.
    images: unsplashImages("1743799349027-93aca0dd6273"),
  },
