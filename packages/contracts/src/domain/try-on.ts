...
// Input for POST /api/try-on. Client sends product ids/categories, never a
// garment image URL directly — the server resolves the real product image
// itself, the same "never trust client-submitted data" principle
